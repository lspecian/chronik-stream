#!/usr/bin/env python3
"""
Create 3000 topics with controlled concurrency (10 threads).
Tests Chronik's ability to handle many topics without overwhelming clients.
"""
import time
...
def main():
    print(f"Creating 3000 topics with 10 concurrent threads...")
    print(f"Started at: {time.strftime('%Y-%m-%d %H:%M:%S')}")

    start_time = time.time()

    # Use only 10 concurrent threads (not 100)
