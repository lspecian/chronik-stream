...
pub use resolve::{
    assemble_all_instances, assemble_entity, assemble_instance, query_objects, resolve_entity,
    resolve_object, EntityView, ObjectInstance, ResolveError, ResolvedAttr, SourceRef,
};
